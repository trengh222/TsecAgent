...
async def _init_components():
    ...
    from deepagent.mcp.executors.HttpSearchExecutor import HttpSearchExecutor
    ...
    _executors = {
        ...
        "recon":       ReconExecutor(_config["recon"]),
        "knowledge":   KnowledgeExecutor(_config["knowledge"]),
        "http_search": HttpSearchExecutor(),
    }
...
app = FastAPI(title="DeepAgent Chat", docs_url="/docs", redoc_url="/redoc")
